...
public class MetricAspect {
    ...
    public Object measureMetrics2(ProceedingJoinPoint pjp) throws Throwable {
    ...
    @Around(
            "execution(* com.example.aspecttp.classes.dummyApp.CachingBenchmark.benchmark*(..)) || " +
            "execution(* com.example.aspecttp.classes.dummyApp.CachingBenchmark.startCachingBenchmark(..))"
    )
